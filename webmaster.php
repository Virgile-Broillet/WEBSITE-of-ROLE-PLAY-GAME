...
<body>
    ...
    <h1><center>Communication avec le WebMaster</center></h1>
    <div id="wrap">
      <ul class="navbar">
        <li>
    ...
    <br/>
			<form action="contact.php" method="get">
				<div class="base">
                    <center><h1> Contactez le WebMaster<br/><br/></h1><h3>
                       Vous pouvez me contacter pour toute demande concernant le site ou un autre site. <br/>
                       Vous pouvez m'écrire à l'adresse email suivante : <br/><br/>
                       <center><h2><a href="mailto:broilletvirgile@gmail.com">broilletvirgile@gmail.com</a></h2></center><br/><br/>
                       
                       Pour un contact plus rapide (gros problème de sécurité du site) <br/>
                       Contactez moi au : <br/><br/>
                       <center><h2>06.59.94.54.20</h2></center>
