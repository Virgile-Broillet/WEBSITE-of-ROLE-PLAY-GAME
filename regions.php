...
<body>
    ...
    <h1><center>Régions du JDR</center></h1>
    <div id="wrap">
      <ul class="navbar">
        <li>
    ...
    <br/>
			<form action="contact.php" method="get">
				<div class="base">
                    <center><h1> Régions du JDR <br/><br/></h1><h3>
                       Vous retrouverez ici toutes les info sur les Régions du JDR lorsqu'elles seront écritent : <br/><br/>
