...
<body>
    ...
    <h1><center>Bienvenue sur l'espace de Communication</center></h1>
    <div id="wrap">
      <ul class="navbar">
        <li>
    ...
    <br/>
			<form action="contact.php" method="get">
				<div class="base">
                    <center><h1> Contactez-nous !<br/>
                       ...
                       <input type="text" name="firstname" placeholder="Prénom" autocomplete="off" class="form-control"/>
							<br/><br/>
						<textarea rows="15" cols="100" name="message" placeholder="Votre message" class="form-control"></textarea>
							<br/>
                ...
                if (isset($_GET['bouton'])){
					if(empty($message)){
					$message = fopen("Reco/'$nom'--'$sm'--'$fn'.txt", "w");
					fwrite($message, $_GET['message']);
					fclose($message);
					echo '<br /><br />Le Message a bien été pris en compte';
					}
				}
