...
<body>
    ...
    <h1><center>Règles du JDR</center></h1>
    <div id="wrap">
      <ul class="navbar">
        <li>
    ...
    <br/>
			<form action="contact.php" method="get">
				<div class="base">
                    <center><h1> Règles du Jeu de Rôle <br/><br/></h1><h3>
                       Vous retrouverez ici toutes les règles du jeu de rôle lorsqu'elles seront écritent : <br/><br/>
