...
<body>
    ...
    <h1><center>Page Info Majeur</center></h1>
    <div id="wrap">
      <ul class="navbar">
        <li>
    ...
    <br/>
			<form action="contact.php" method="get">
				<div class="base">
                    <center><h1> Info Majeur <br/><br/></h1><h3>
                       Vous retrouverez ici toutes les info de la catégorie Majeur lorsqu'elles seront écritent : <br/><br/>
