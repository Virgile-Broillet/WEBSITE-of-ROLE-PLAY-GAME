...
<body>
    ...
    <h1><center>Evènement du Jeu de Rôle</center></h1>
    <div id="wrap">
      <ul class="navbar">
        <li>
    ...
    <br/>
			<form action="contact.php" method="get">
				<div class="base">
                    <center><h1> Calendrier d'Evenements <br/><br/></h1><h3>
                       Vous retrouverez ici toutes les dates des évènements du jeu de rôle lorsqu'elles seront décidées : <br/><br/>
