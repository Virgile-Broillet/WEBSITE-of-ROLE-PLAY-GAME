...
<body>
    ...
    <h1><center>Sub Classe</center></h1>
    <div id="wrap">
      <ul class="navbar">
        <li>
    ...
    <br/>
			<form action="contact.php" method="get">
				<div class="base">
                    <center><h1> Sub Classe <br/><br/></h1><h3>
                       Vous retrouverez ici toutes les info des Subs Classes lorsqu'elles seront écritent : <br/><br/>
